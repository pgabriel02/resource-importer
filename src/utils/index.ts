...
export { makeMarkdownFile, makeImgFolder, removeImgFile, removeMarkdownFiles } from './filesManager'
export { generateConfig, generateMetaDataConfigAsString, getMetadataConfig } from './parseDataCollection'